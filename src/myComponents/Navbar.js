    ...
    <div className='navbar-section relative xl:bg-gray-500'>
        <div className="header flex items-center justify-between p-3 lg:relative lg:bottom-1">
            <div className="logodiv">
                <Link to="/">
                    <img className='w-24 xl:relative xl:z-[100000]' src="../assets/logo.png" alt="" />
                </Link>
            </div>
            
        <div className={`${active} bg-slate-600 w-full p-4 text-center absolute top-0 left-[-500%] z-[3000] lg:left-0 lg:bg-transparent xl:bg-white justify-center lg: flex lg:items-center lg:justify-end`}>
            <div className="navList lg:flex lg:items-center">
                <li className='navItem list-none lg:mr-4'>
                    <Link to="/" className={`navLink text-xl font-medium hover:text-[#4668DF] hover:cursor-pointer ${activeLink === "Home" ? "text-[#775BE5]" : "text-black"}`} onClick={() => setActiveLink("Home")}>Home</Link>
                </li>
                <li className='navItem list-none mt-2 lg:mt-0 lg:mr-4'>
                    <Link to="/about" className={`navLink text-xl font-medium hover:text-[#4668DF] hover:cursor-pointer ${activeLink === "About" ? "text-[#775BE5]" : "text-black"}`} onClick={() => setActiveLink("About")}>About</Link>
                </li>
                <li className='navItem list-none mt-2 lg:mt-0 lg:mr-4'>
                    <Link to="/rentals" className={`navLink text-xl font-medium hover:text-[#4668DF] hover:cursor-pointer ${activeLink === "Rentals" ? "text-[#775BE5]" : "text-black"}`} onClick={() => setActiveLink("Rentals")}>Rentals</Link>
                </li>
                <li className='navItem list-none mt-2 lg:mt-0 lg:mr-4'>
                    <Link to="/contact" className={`navLink text-xl font-medium hover:text-[#4668DF]  hover:cursor-pointer ${activeLink === "Contact" ? "text-[#775BE5]" : "text-black"}`} onClick={() => setActiveLink("Contact")}>Contact</Link>
                </li>
